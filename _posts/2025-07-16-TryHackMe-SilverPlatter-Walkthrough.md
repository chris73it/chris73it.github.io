...
![Silverplatter's front page](/assets/silverplatter-web-site.png){: .bordered-image}

Clicking on the **CONTACT** link we access this juicy piece of information disclosure:

![Silverplatter's CONTACT page](/assets/silverplatter-web-site-contact.png){: .bordered-image}
...
![Silverpeas Login Window](/assets/silverpeas-login-window.webp){: .bordered-image}
...
![Silverpeas Login Window](/assets/silverpeas-scr1ptkiddy-main-menu.webp){: .bordered-image}

Then if we click on the See more link …

![Silverpeas Login Window](/assets/silverpeas-scr1ptkiddy-see-more-link.webp){: .bordered-image}

… we land on this page

![Silverpeas Login Window](/assets/silverpeas-scr1ptkiddy-inbox.webp){: .bordered-image}

Now, when we click on the Game Night link, a window opens …

![Silverpeas Login Window](/assets/silverpeas-scr1ptkiddy-idor.webp){: .bordered-image}
...
![Silverpeas Login Window](/assets/silverpeas-scr1ptkiddy-tim-ssh.webp){: .bordered-image}
